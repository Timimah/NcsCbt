    ...
    return (
        <div className="mx-auto px-4">
            <div className="text-center">
                <h2 className="text-4xl text-primary mb-4">CONTACT INFORMATION</h2>
            ...
            <div className="p-20 flex gap-10">
                <div className='w-2/3'>
                    <h3 className="text-4xl font-semibold text-primary mb-4">SEND ME A MESSAGE</h3>
                    <p className="mb-6 text-grey">Have a specific inquiry or message for us? Please use the contact form below, and we'll get back to you promptly.</p>
                </div>
