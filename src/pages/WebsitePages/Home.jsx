        ...
        {isMenuOpen &&
          ...
          >
            <div className="grid grid-cols-2">
              <Link to="/" onClick={toggleMenu} className="py-3 px-4 font-semibold text-primary hover:bg-primary hover:text-white text-center rounded-md">Home</Link>
              <Link onClick={() => {
                toggleMenu();
                scrollToSection('about');
              }}
                className="py-3 px-4 font-semibold text-primary hover:bg-primary hover:text-white text-center rounded-md">About Us</Link>
              <Link onClick={() => {
                toggleMenu();
                scrollToSection('pricing');
              }}
                className="py-3 px-4 font-semibold text-primary hover:bg-primary hover:text-white text-center rounded-md">Pricing</Link>
              <Link onClick={() => {
                toggleMenu();
      ...
      <main className="flex-grow px-5 md:px-0">
        <section id="home" className="py-20 px-6">
          <div className="max-w-3xl mx-auto text-center flex flex-col items-center justify-center">
            <h1 className="text-2xl md:text-5xl font-bold mb-4 text-primary">Nigeria Customs Service 2024 CBT Practice </h1>
            ...
            <img src={screenshot} alt="Application Screenshot" className="md:mx-auto my-8 mx-10" />
          </div>
        </section>

        <section id="about" className="text-center md:py-20 md:px-6">
          <div className="max-w-3xl mx-auto">
            <h2 className=" text-2xl md:text-4xl text-primary font-bold mb-8">What we've achieved so far <br /> <span className='text-sm font-normal'>Register with us today to get rid of the fear of using a computer</span></h2>
        ...
        <section className="py-12 px-6 text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl md:text-4xl font-bold mb-2 text-primary">Features</h2>
        ...
        <section className="bg-story py-20 px-10 md:px-32">
          <div className="md:px-20">
            <img className='inset-0 -ml-10 md:-ml-32 w-32' src={quote} alt={quote} />
