                            ...
                            displayedMaterials.map((material) => (
                                <div className="p-4">
                                    ...
                                    <div className="flex gap-2 w-fit text-xs font-thin">
                                        <Button title="View" btnStyles=" text-secondary bg-yellow px-2 py-1 rounded-md" btnClick={() => console.log(material.url)} />
                                        <Button title="Download" btnStyles=" text-secondary bg-yellow px-2 py-1 rounded-md" />
                                    </div>
                                </div>
                            ))
                        ) : (
