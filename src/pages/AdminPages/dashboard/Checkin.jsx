                    ...
                    <div className='flex flex-col items-center gap-4 my-2'>
                        <div>
                            ...
                            <input
                                type="text"
                                value={eID}
                                onChange={(e) => { setEID(e.target.value); setError(""); }}
                                className="border rounded-md py-2 px-4 pr-10 w-full"
